...
namespace IsuExtra
{
    internal class Program
    {
        private static void Main()
        {
            ...
            var m3205 = new GroupWithLessons(new GroupName("M3205"));
            var m3206 = new GroupWithLessons(new GroupName("M3206"));
            ...
            var friday = new StudyDay(new List<Lesson>() { matan, osi }, WeekDay.Thursday);

            var studyDaysM3204 = new List<StudyDay>() { monday, friday };
